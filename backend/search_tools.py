...
class CourseSearchTool(Tool):
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            # Build source dict with optional URL
            text = course_title
            if lesson_num is not None:
...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Retrieve the full outline of a course: its title, course link, and a numbered list of all lessons with their titles",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
